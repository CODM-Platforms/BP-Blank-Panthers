  ...
  return (
    <div className="max-w-4xl mx-auto animate-fade-in">
      <div className="mb-8">
        ...
        <p className="text-panther-text mt-2">Configure a new clan battle.</p>
      </div>
        ...
        <form action={createTournament} className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input type="text" name="name" required placeholder="e.g., Friday Night Clan Battle" className="w-full bg-panther-dark border border-panther-border rounded-lg px-4 py-3 text-white focus:outline-none focus:border-panther-gold transition-colors" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select name="mode" required defaultValue="BR" className="w-full bg-panther-dark border border-panther-border rounded-lg pl-10 pr-4 py-3 text-white focus:outline-none focus:border-panther-gold transition-colors appearance-none">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select name="teamSize" required defaultValue="4" className="w-full bg-panther-dark border border-panther-border rounded-lg px-4 py-3 text-white focus:outline-none focus:border-panther-gold transition-colors appearance-none">
              ...
              <div>
                ...
                <input type="number" name="maxPlayers" required defaultValue={100} min={1} className="w-full bg-panther-dark border border-panther-border rounded-lg px-4 py-3 text-white focus:outline-none focus:border-panther-gold transition-colors" />
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input type="datetime-local" name="tournamentDate" required className="w-full bg-panther-dark border border-panther-border rounded-lg px-4 py-3 text-white focus:outline-none focus:border-panther-gold transition-colors" />
              </div>
              <div>
                <label className="block text-sm font-medium text-panther-text mb-1">Registration Deadline</label>
                <input type="datetime-local" name="registrationEnd" required className="w-full bg-panther-dark border border-panther-border rounded-lg px-4 py-3 text-white focus:outline-none focus:border-panther-gold transition-colors" />
              </div>
            </div>
          </div>
          ...
          <div className="pt-4 flex items-center justify-end gap-4 border-t border-panther-border">
            ...
            <button type="submit" className="px-8 py-3 bg-panther-gold text-panther-dark rounded-lg font-bold hover:bg-panther-gold-hover transition-colors shadow-[0_0_15px_rgba(230,200,117,0.3)]">
